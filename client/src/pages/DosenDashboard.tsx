              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  <div className="p-5">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Manage your courses and assignments</p>
                  </div>
                </div>
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  <div className="p-5">
                    <h3 className="text-lg font-medium">Group Management</h3>
                    <p className="mt-1 text-sm text-gray-500">Manage student groups</p>
                  </div>
                </div>
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  <div className="p-5">
                    <h3 className="text-lg font-medium">Grading</h3>
                    <p className="mt-1 text-sm text-gray-500">Review and grade assignments</p>
                  </div>
                </div>
              </div>
            </div>
